...
if animal=='cachorro':
    if tipo=='médio porte':
        if idade == 'filhote':
            ...
            print("Treinamento básico, alimentação balanceada para crescimento, socialização com outros animais.")

if animal=='cachorro':
    if tipo=='médio porte':
        if idade == 'adulto':

            print("Atividades físicas diárias, cuidados com unhas e ouvidos, vacinação em dia, controle de peso.")

if animal=='cachorro':
    if tipo=='médio porte':
        if idade == 'idoso':

            print("Cama ortopédica, dieta rica em fibras, checagem de artrite, check-up semestral.")
...
if animal=='ave':
    if tipo=='pequeno porte':
        if idade == 'filhote':
            ...
            print("Alimentação com papa específica, aquecimento controlado, manipulação suave e frequente.")

if animal=='ave':
    if tipo=='pequeno porte':
        if idade == 'adulto':

            print("Gaiola ampla, dieta variada (sementes + frutas/verduras), socialização, banhos regulares.")
...
if animal=='ave':
    if tipo=='médio porte':
        if idade == 'filhote':
            ...
            print("Cuidado com a alimentação manual, controle de calor, socialização para evitar agressividade.")

if animal=='ave':
    if tipo=='médio porte':
        if idade == 'adulto':

            print("Interação diária, brinquedos para bico, dieta equilibrada com pellets, visitas veterinárias.")
...
if animal=='ave':
    if tipo=='grande porte':
        if idade == 'filhote':
            ...
            print("Alimentação assistida, vinculação com tutor, introdução a brinquedos e comandos simples.")
